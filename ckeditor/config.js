	...
	CKEDITOR.editorConfig = function (config) {
        ...
        ***/
		...
		(config.filebrowserBrowseUrl =
			"https://sic88.org/ckeditor/ckfinder/ckfinder.php"),
			(config.filebrowserUploadUrl =
				"https://sic88.org/ckeditor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Files"),
			(config.filebrowserImageUploadUrl =
				"https://sic88.org/ckeditor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Images"),
			(config.filebrowserFlashUploadUrl =
				"https://sic88.org/ckeditor/ckfinder/core/connector/php/connector.php?command=QuickUpload&type=Flash"),
			// My Plugin
			/*/		
            config.plugins =
            // Plugin
